...
import { LayoutDashboard, Dumbbell, Calendar, BarChart3, Bot, User, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-3 m-2 rounded-lg hover:bg-sidebar-accent transition-colors text-sidebar-foreground"
      >
